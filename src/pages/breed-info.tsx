  ...
  return (
    <SiteLayout title="Breed Info | WeimWisdom" description="History, temperament, and care guidance for Weimaraners.">
      <PageHero
        ...
        description="The Weim Life: what the breed was built for, what daily life looks like, their stunning variants, and how to support a happy, fulfilled Weimaraner."
      />
      <SectionBlock
