  ...
  return (
    <SiteLayout title="Adoption | WeimWisdom" description="Adoption spotlights and preparation guidance for Weimaraner families.">
      ...
      <SectionBlock
        ...
        description={[
          `These live listings are pulled from participating Weimaraner rescue organizations so visitors can see currently adoptable dogs. If no results are showing you may have to turn off your VPN if you are using one.`,
